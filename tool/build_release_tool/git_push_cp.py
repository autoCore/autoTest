...
class DownloadToolController(object):
    def __init__(self,_cfg,_logger):
        ...
        self.download_tool_release_dir = _cfg.download_tool_release_dir
        self.download_tool_file_name = _cfg.download_tool_file_name
        self.partition_config = _cfg.partition_config
        self.template_config = _cfg.template_config
