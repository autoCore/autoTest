...
def jtat_connect():
	...
	t32api.T32_Config(b"NODE=",conf.get('jtag_config','t32_IP'))
	t32api.T32_Config(b"PORT=",conf.get('jtag_config','t32_PORT'))
	t32api.T32_Config(b"PACKLEN=",conf.get('jtag_config','t32_PACKLEN'))
