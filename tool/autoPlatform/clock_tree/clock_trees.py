...
sys.path.append("./tool/autoPlatform/auto")
...
if __name__ == "__main__":
	...
	arg_parser.add_argument('-f','--file',default = './tool/autoPlatform/clock_tree/aquilac_clock.xlsx',help = 'please input command, example,build autotest_j,autotest_v,ddr_current,uart,benchmark')
	...
	output_file = './tool/autoPlatform/clock_tree/clock_info.xls'
